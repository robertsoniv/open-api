...
export class AdminUserGroupApi {
     ...
     * @param UserGroup 
     */
    public createV1usergroups (UserGroup: UserGroup) : Promise<{ response: http.ClientResponse; body: UserGroup;  }> {
        ...
        if (UserGroup === null || UserGroup === undefined) {
            throw new Error('Required parameter UserGroup was null or undefined when calling createV1usergroups.');
        }
     ...
     */
    public deleteUserAssignmentV1usergroupsuserGroupIDassignmentsuserID (UserGroupID: string, UserID: string) : Promise<{ response: http.ClientResponse; body?: any;  }> {
        ...
        if (UserGroupID === null || UserGroupID === undefined) {
            throw new Error('Required parameter UserGroupID was null or undefined when calling deleteUserAssignmentV1usergroupsuserGroupIDassignmentsuserID.');
        }

        // verify required parameter 'UserID' is not null or undefined
        if (UserID === null || UserID === undefined) {
            throw new Error('Required parameter UserID was null or undefined when calling deleteUserAssignmentV1usergroupsuserGroupIDassignmentsuserID.');
        }
     ...
     * @param UserGroupID ID of the user group.
     */
    public deleteV1usergroupsuserGroupID (UserGroupID: string) : Promise<{ response: http.ClientResponse; body?: any;  }> {
        ...
        // verify required parameter 'UserGroupID' is not null or undefined
        if (UserGroupID === null || UserGroupID === undefined) {
            throw new Error('Required parameter UserGroupID was null or undefined when calling deleteV1usergroupsuserGroupID.');
        }
     ...
     * @param UserGroupID ID of the user group.
     */
    public getV1usergroupsuserGroupID (UserGroupID: string) : Promise<{ response: http.ClientResponse; body: UserGroup;  }> {
        const localVarPath = this.basePath + '/usergroups/{userGroupID}'
            .replace('{' + 'userGroupID' + '}', encodeURIComponent(String(UserGroupID)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        // verify required parameter 'UserGroupID' is not null or undefined
        if (UserGroupID === null || UserGroupID === undefined) {
            throw new Error('Required parameter UserGroupID was null or undefined when calling getV1usergroupsuserGroupID.');
        }
     ...
     */
    public listUserAssignmentsV1usergroupsassignments (UserGroupID?: string, UserID?: string, Page?: number, PageSize?: number) : Promise<{ response: http.ClientResponse; body: ListUserGroupAssignment;  }> {
     ...
     */
    public listV1usergroups (Search?: string, SearchOn?: string, SortBy?: string, Page?: number, PageSize?: number, Filters?: any) : Promise<{ response: http.ClientResponse; body: ListUserGroup;  }> {
        const localVarPath = this.basePath + '/usergroups';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
     ...
     * @param UserGroup 
     */
    public patchV1usergroupsuserGroupID (UserGroupID: string, UserGroup: UserGroup) : Promise<{ response: http.ClientResponse; body: UserGroup;  }> {
        const localVarPath = this.basePath + '/usergroups/{userGroupID}'
            .replace('{' + 'userGroupID' + '}', encodeURIComponent(String(UserGroupID)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        // verify required parameter 'UserGroupID' is not null or undefined
        if (UserGroupID === null || UserGroupID === undefined) {
            throw new Error('Required parameter UserGroupID was null or undefined when calling patchV1usergroupsuserGroupID.');
        }

        // verify required parameter 'UserGroup' is not null or undefined
        if (UserGroup === null || UserGroup === undefined) {
            throw new Error('Required parameter UserGroup was null or undefined when calling patchV1usergroupsuserGroupID.');
        }
     ...
     */
    public saveUserAssignmentV1usergroupsassignments (UserGroupAssignment: UserGroupAssignment) : Promise<{ response: http.ClientResponse; body?: any;  }> {
        const localVarPath = this.basePath + '/usergroups/assignments';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
        ...
        if (UserGroupAssignment === null || UserGroupAssignment === undefined) {
            throw new Error('Required parameter UserGroupAssignment was null or undefined when calling saveUserAssignmentV1usergroupsassignments.');
        }
     ...
     * @param UserGroup 
     */
    public saveV1usergroupsuserGroupID (UserGroupID: string, UserGroup: UserGroup) : Promise<{ response: http.ClientResponse; body: UserGroup;  }> {
        const localVarPath = this.basePath + '/usergroups/{userGroupID}'
            .replace('{' + 'userGroupID' + '}', encodeURIComponent(String(UserGroupID)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        // verify required parameter 'UserGroupID' is not null or undefined
        if (UserGroupID === null || UserGroupID === undefined) {
            throw new Error('Required parameter UserGroupID was null or undefined when calling saveV1usergroupsuserGroupID.');
        }

        // verify required parameter 'UserGroup' is not null or undefined
        if (UserGroup === null || UserGroup === undefined) {
            throw new Error('Required parameter UserGroup was null or undefined when calling saveV1usergroupsuserGroupID.');
        }
