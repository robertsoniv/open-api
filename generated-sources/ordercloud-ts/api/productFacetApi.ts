...
export class ProductFacetApi {
     ...
     * @param ProductFacet 
     */
    public createV1productfacets (ProductFacet: ProductFacet) : Promise<{ response: http.ClientResponse; body: ProductFacet;  }> {
        ...
        if (ProductFacet === null || ProductFacet === undefined) {
            throw new Error('Required parameter ProductFacet was null or undefined when calling createV1productfacets.');
        }
     ...
     */
    public deleteV1productfacetsproductFacetID (ProductFacetID: string) : Promise<{ response: http.ClientResponse; body?: any;  }> {
        ...
        if (ProductFacetID === null || ProductFacetID === undefined) {
            throw new Error('Required parameter ProductFacetID was null or undefined when calling deleteV1productfacetsproductFacetID.');
        }
     ...
     * @param ProductFacetID ID of the product facet.
     */
    public getV1productfacetsproductFacetID (ProductFacetID: string) : Promise<{ response: http.ClientResponse; body: ProductFacet;  }> {
        const localVarPath = this.basePath + '/productfacets/{productFacetID}'
            .replace('{' + 'productFacetID' + '}', encodeURIComponent(String(ProductFacetID)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        // verify required parameter 'ProductFacetID' is not null or undefined
        if (ProductFacetID === null || ProductFacetID === undefined) {
            throw new Error('Required parameter ProductFacetID was null or undefined when calling getV1productfacetsproductFacetID.');
        }
     ...
     */
    public listV1productfacets (Search?: string, SearchOn?: string, SortBy?: string, Page?: number, PageSize?: number, Filters?: any) : Promise<{ response: http.ClientResponse; body: ListProductFacet;  }> {
        const localVarPath = this.basePath + '/productfacets';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
     ...
     * @param ProductFacet 
     */
    public patchV1productfacetsproductFacetID (ProductFacetID: string, ProductFacet: ProductFacet) : Promise<{ response: http.ClientResponse; body: ProductFacet;  }> {
        const localVarPath = this.basePath + '/productfacets/{productFacetID}'
            .replace('{' + 'productFacetID' + '}', encodeURIComponent(String(ProductFacetID)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        // verify required parameter 'ProductFacetID' is not null or undefined
        if (ProductFacetID === null || ProductFacetID === undefined) {
            throw new Error('Required parameter ProductFacetID was null or undefined when calling patchV1productfacetsproductFacetID.');
        }

        // verify required parameter 'ProductFacet' is not null or undefined
        if (ProductFacet === null || ProductFacet === undefined) {
            throw new Error('Required parameter ProductFacet was null or undefined when calling patchV1productfacetsproductFacetID.');
        }
     ...
     * @param ProductFacet 
     */
    public saveV1productfacetsproductFacetID (ProductFacetID: string, ProductFacet: ProductFacet) : Promise<{ response: http.ClientResponse; body: ProductFacet;  }> {
        const localVarPath = this.basePath + '/productfacets/{productFacetID}'
            .replace('{' + 'productFacetID' + '}', encodeURIComponent(String(ProductFacetID)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        // verify required parameter 'ProductFacetID' is not null or undefined
        if (ProductFacetID === null || ProductFacetID === undefined) {
            throw new Error('Required parameter ProductFacetID was null or undefined when calling saveV1productfacetsproductFacetID.');
        }

        // verify required parameter 'ProductFacet' is not null or undefined
        if (ProductFacet === null || ProductFacet === undefined) {
            throw new Error('Required parameter ProductFacet was null or undefined when calling saveV1productfacetsproductFacetID.');
        }
