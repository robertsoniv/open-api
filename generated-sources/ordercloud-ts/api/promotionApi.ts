...
export class PromotionApi {
     ...
     * @param Promotion 
     */
    public createPromotions (Promotion: Promotion) : Promise<{ response: http.ClientResponse; body: Promotion;  }> {
        ...
        if (Promotion === null || Promotion === undefined) {
            throw new Error('Required parameter Promotion was null or undefined when calling createPromotions.');
        }
     ...
     */
    public deleteAssignmentPromotions (PromotionID: string, BuyerID: string, UserID?: string, UserGroupID?: string) : Promise<{ response: http.ClientResponse; body?: any;  }> {
        ...
        if (PromotionID === null || PromotionID === undefined) {
            throw new Error('Required parameter PromotionID was null or undefined when calling deleteAssignmentPromotions.');
        }

        // verify required parameter 'BuyerID' is not null or undefined
        if (BuyerID === null || BuyerID === undefined) {
            throw new Error('Required parameter BuyerID was null or undefined when calling deleteAssignmentPromotions.');
        }
     ...
     * @param PromotionID ID of the promotion.
     */
    public deletePromotions (PromotionID: string) : Promise<{ response: http.ClientResponse; body?: any;  }> {
        ...
        // verify required parameter 'PromotionID' is not null or undefined
        if (PromotionID === null || PromotionID === undefined) {
            throw new Error('Required parameter PromotionID was null or undefined when calling deletePromotions.');
        }
     ...
     * @param PromotionID ID of the promotion.
     */
    public getPromotions (PromotionID: string) : Promise<{ response: http.ClientResponse; body: Promotion;  }> {
        const localVarPath = this.basePath + '/promotions/{promotionID}'
            .replace('{' + 'promotionID' + '}', encodeURIComponent(String(PromotionID)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        // verify required parameter 'PromotionID' is not null or undefined
        if (PromotionID === null || PromotionID === undefined) {
            throw new Error('Required parameter PromotionID was null or undefined when calling getPromotions.');
        }
     ...
     */
    public listAssignmentsPromotions (BuyerID?: string, PromotionID?: string, UserID?: string, UserGroupID?: string, Level?: string, Page?: number, PageSize?: number) : Promise<{ response: http.ClientResponse; body: ListPromotionAssignment;  }> {
     ...
     */
    public listPromotions (Search?: string, SearchOn?: string, SortBy?: string, Page?: number, PageSize?: number, Filters?: any) : Promise<{ response: http.ClientResponse; body: ListPromotion;  }> {
        const localVarPath = this.basePath + '/promotions';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
     ...
     * @param Promotion 
     */
    public patchPromotions (PromotionID: string, Promotion: Promotion) : Promise<{ response: http.ClientResponse; body: Promotion;  }> {
        const localVarPath = this.basePath + '/promotions/{promotionID}'
            .replace('{' + 'promotionID' + '}', encodeURIComponent(String(PromotionID)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        // verify required parameter 'PromotionID' is not null or undefined
        if (PromotionID === null || PromotionID === undefined) {
            throw new Error('Required parameter PromotionID was null or undefined when calling patchPromotions.');
        }

        // verify required parameter 'Promotion' is not null or undefined
        if (Promotion === null || Promotion === undefined) {
            throw new Error('Required parameter Promotion was null or undefined when calling patchPromotions.');
        }
     ...
     */
    public saveAssignmentPromotions (PromotionAssignment: PromotionAssignment) : Promise<{ response: http.ClientResponse; body?: any;  }> {
        const localVarPath = this.basePath + '/promotions/assignments';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
        ...
        if (PromotionAssignment === null || PromotionAssignment === undefined) {
            throw new Error('Required parameter PromotionAssignment was null or undefined when calling saveAssignmentPromotions.');
        }
     ...
     * @param Promotion 
     */
    public savePromotions (PromotionID: string, Promotion: Promotion) : Promise<{ response: http.ClientResponse; body: Promotion;  }> {
        const localVarPath = this.basePath + '/promotions/{promotionID}'
            .replace('{' + 'promotionID' + '}', encodeURIComponent(String(PromotionID)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        // verify required parameter 'PromotionID' is not null or undefined
        if (PromotionID === null || PromotionID === undefined) {
            throw new Error('Required parameter PromotionID was null or undefined when calling savePromotions.');
        }

        // verify required parameter 'Promotion' is not null or undefined
        if (Promotion === null || Promotion === undefined) {
            throw new Error('Required parameter Promotion was null or undefined when calling savePromotions.');
        }
