...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrderCloud.ProductFacet();
  });
  ...
  describe('ProductFacet', function() {
    it('should create an instance of ProductFacet', function() {
      // uncomment below and update the code to test ProductFacet
      //var instance = new OrderCloud.ProductFacet();
      //expect(instance).to.be.a(OrderCloud.ProductFacet);
    });
