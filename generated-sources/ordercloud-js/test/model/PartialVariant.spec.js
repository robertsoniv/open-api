...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrderCloud.PartialVariant();
  });
  ...
  describe('PartialVariant', function() {
    it('should create an instance of PartialVariant', function() {
      // uncomment below and update the code to test PartialVariant
      //var instance = new OrderCloud.PartialVariant();
      //expect(instance).to.be.a(OrderCloud.PartialVariant);
    });
