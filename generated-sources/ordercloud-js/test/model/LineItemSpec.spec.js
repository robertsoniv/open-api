...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrderCloud.LineItemSpec();
  });
  ...
  describe('LineItemSpec', function() {
    it('should create an instance of LineItemSpec', function() {
      // uncomment below and update the code to test LineItemSpec
      //var instance = new OrderCloud.LineItemSpec();
      //expect(instance).to.be.a(OrderCloud.LineItemSpec);
    });
