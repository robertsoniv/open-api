...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrderCloud.PromotionAssignment();
  });
  ...
  describe('PromotionAssignment', function() {
    it('should create an instance of PromotionAssignment', function() {
      // uncomment below and update the code to test PromotionAssignment
      //var instance = new OrderCloud.PromotionAssignment();
      //expect(instance).to.be.a(OrderCloud.PromotionAssignment);
    });
