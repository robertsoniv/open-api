...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrderCloud.PartialCatalog();
  });
  ...
  describe('PartialCatalog', function() {
    it('should create an instance of PartialCatalog', function() {
      // uncomment below and update the code to test PartialCatalog
      //var instance = new OrderCloud.PartialCatalog();
      //expect(instance).to.be.a(OrderCloud.PartialCatalog);
    });
