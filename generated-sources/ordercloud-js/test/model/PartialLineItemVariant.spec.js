...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrderCloud.PartialLineItemVariant();
  });
  ...
  describe('PartialLineItemVariant', function() {
    it('should create an instance of PartialLineItemVariant', function() {
      // uncomment below and update the code to test PartialLineItemVariant
      //var instance = new OrderCloud.PartialLineItemVariant();
      //expect(instance).to.be.a(OrderCloud.PartialLineItemVariant);
    });
