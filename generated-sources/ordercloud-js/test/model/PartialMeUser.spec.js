...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrderCloud.PartialMeUser();
  });
  ...
  describe('PartialMeUser', function() {
    it('should create an instance of PartialMeUser', function() {
      // uncomment below and update the code to test PartialMeUser
      //var instance = new OrderCloud.PartialMeUser();
      //expect(instance).to.be.a(OrderCloud.PartialMeUser);
    });
