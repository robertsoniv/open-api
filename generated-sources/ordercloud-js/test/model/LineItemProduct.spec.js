...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrderCloud.LineItemProduct();
  });
  ...
  describe('LineItemProduct', function() {
    it('should create an instance of LineItemProduct', function() {
      // uncomment below and update the code to test LineItemProduct
      //var instance = new OrderCloud.LineItemProduct();
      //expect(instance).to.be.a(OrderCloud.LineItemProduct);
    });
