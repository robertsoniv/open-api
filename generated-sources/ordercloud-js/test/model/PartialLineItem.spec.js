...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrderCloud.PartialLineItem();
  });
  ...
  describe('PartialLineItem', function() {
    it('should create an instance of PartialLineItem', function() {
      // uncomment below and update the code to test PartialLineItem
      //var instance = new OrderCloud.PartialLineItem();
      //expect(instance).to.be.a(OrderCloud.PartialLineItem);
    });
