...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrderCloud.PartialUser();
  });
  ...
  describe('PartialUser', function() {
    it('should create an instance of PartialUser', function() {
      // uncomment below and update the code to test PartialUser
      //var instance = new OrderCloud.PartialUser();
      //expect(instance).to.be.a(OrderCloud.PartialUser);
    });
