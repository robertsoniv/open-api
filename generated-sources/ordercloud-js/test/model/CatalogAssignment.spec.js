...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrderCloud.CatalogAssignment();
  });
  ...
  describe('CatalogAssignment', function() {
    it('should create an instance of CatalogAssignment', function() {
      // uncomment below and update the code to test CatalogAssignment
      //var instance = new OrderCloud.CatalogAssignment();
      //expect(instance).to.be.a(OrderCloud.CatalogAssignment);
    });
