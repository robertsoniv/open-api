...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrderCloud.PartialBuyerCreditCard();
  });
  ...
  describe('PartialBuyerCreditCard', function() {
    it('should create an instance of PartialBuyerCreditCard', function() {
      // uncomment below and update the code to test PartialBuyerCreditCard
      //var instance = new OrderCloud.PartialBuyerCreditCard();
      //expect(instance).to.be.a(OrderCloud.PartialBuyerCreditCard);
    });
