...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrderCloud.PartialBuyerAddress();
  });
  ...
  describe('PartialBuyerAddress', function() {
    it('should create an instance of PartialBuyerAddress', function() {
      // uncomment below and update the code to test PartialBuyerAddress
      //var instance = new OrderCloud.PartialBuyerAddress();
      //expect(instance).to.be.a(OrderCloud.PartialBuyerAddress);
    });
