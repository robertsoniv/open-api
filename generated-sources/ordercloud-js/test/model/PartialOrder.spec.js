...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrderCloud.PartialOrder();
  });
  ...
  describe('PartialOrder', function() {
    it('should create an instance of PartialOrder', function() {
      // uncomment below and update the code to test PartialOrder
      //var instance = new OrderCloud.PartialOrder();
      //expect(instance).to.be.a(OrderCloud.PartialOrder);
    });
