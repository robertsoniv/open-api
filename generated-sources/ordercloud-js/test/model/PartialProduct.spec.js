...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrderCloud.PartialProduct();
  });
  ...
  describe('PartialProduct', function() {
    it('should create an instance of PartialProduct', function() {
      // uncomment below and update the code to test PartialProduct
      //var instance = new OrderCloud.PartialProduct();
      //expect(instance).to.be.a(OrderCloud.PartialProduct);
    });
