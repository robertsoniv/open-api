...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrderCloud.PartialLineItemProduct();
  });
  ...
  describe('PartialLineItemProduct', function() {
    it('should create an instance of PartialLineItemProduct', function() {
      // uncomment below and update the code to test PartialLineItemProduct
      //var instance = new OrderCloud.PartialLineItemProduct();
      //expect(instance).to.be.a(OrderCloud.PartialLineItemProduct);
    });
