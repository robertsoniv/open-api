...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the deleteAssignmentMessageSenders operation.
     * @callback module:api/MessageSenderApi~deleteAssignmentMessageSendersCallback
     ...
     * @param {module:api/MessageSenderApi~deleteAssignmentMessageSendersCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.deleteAssignmentMessageSenders = function(messageSenderID, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'messageSenderID' is set
      if (messageSenderID === undefined || messageSenderID === null) {
        throw new Error("Missing the required parameter 'messageSenderID' when calling deleteAssignmentMessageSenders");
      }
    ...
    /**
     * Callback function to receive the result of the getMessageSenders operation.
     * @callback module:api/MessageSenderApi~getMessageSendersCallback
     * @param {String} error Error message, if any.
    ...
    /**
     * @param {String} messageSenderID ID of the message sender.
     * @param {module:api/MessageSenderApi~getMessageSendersCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/MessageSender}
     */
    this.getMessageSenders = function(messageSenderID, callback) {
      var postBody = null;

      // verify the required parameter 'messageSenderID' is set
      if (messageSenderID === undefined || messageSenderID === null) {
        throw new Error("Missing the required parameter 'messageSenderID' when calling getMessageSenders");
      }
    ...
    /**
     * Callback function to receive the result of the listAssignmentsMessageSenders operation.
     * @callback module:api/MessageSenderApi~listAssignmentsMessageSendersCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} opts.supplierID ID of the supplier.
     * @param {module:api/MessageSenderApi~listAssignmentsMessageSendersCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ListMessageSenderAssignment}
     */
    this.listAssignmentsMessageSenders = function(opts, callback) {
      opts = opts || {};
      var postBody = null;
    ...
    /**
     * Callback function to receive the result of the listCCListenerAssignmentsMessageSenders operation.
     * @callback module:api/MessageSenderApi~listCCListenerAssignmentsMessageSendersCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/MessageSenderApi~listCCListenerAssignmentsMessageSendersCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ListMessageCCListenerAssignment}
     */
    this.listCCListenerAssignmentsMessageSenders = function(opts, callback) {
      opts = opts || {};
      var postBody = null;
    ...
    /**
     * Callback function to receive the result of the listMessageSenders operation.
     * @callback module:api/MessageSenderApi~listMessageSendersCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} opts.pageSize Number of results to return per page. Default: 20, max: 100.
     * @param {Object} opts.filters Any additional key/value pairs passed in the query string are interpretted as filters. Valid keys are top-level properties of the returned model or &#39;xp.???&#39;
     * @param {module:api/MessageSenderApi~listMessageSendersCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ListMessageSender}
     */
    this.listMessageSenders = function(opts, callback) {
      opts = opts || {};
      var postBody = null;
    ...
    /**
     * Callback function to receive the result of the saveAssignmentMessageSenders operation.
     * @callback module:api/MessageSenderApi~saveAssignmentMessageSendersCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/MessageSenderApi~saveAssignmentMessageSendersCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.saveAssignmentMessageSenders = function(messageSenderAssignment, callback) {
      ...
      if (messageSenderAssignment === undefined || messageSenderAssignment === null) {
        throw new Error("Missing the required parameter 'messageSenderAssignment' when calling saveAssignmentMessageSenders");
      }
    ...
    /**
     * Callback function to receive the result of the saveCCListenerAssignmentMessageSenders operation.
     * @callback module:api/MessageSenderApi~saveCCListenerAssignmentMessageSendersCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/MessageSenderApi~saveCCListenerAssignmentMessageSendersCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.saveCCListenerAssignmentMessageSenders = function(messageCCListenerAssignment, callback) {
      ...
      if (messageCCListenerAssignment === undefined || messageCCListenerAssignment === null) {
        throw new Error("Missing the required parameter 'messageCCListenerAssignment' when calling saveCCListenerAssignmentMessageSenders");
      }
